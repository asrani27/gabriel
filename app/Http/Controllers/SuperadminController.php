...
class SuperadminController extends Controller
{
    ...
    public function pelunasan()
    {
        ...
        return view('superadmin.pelunasan.index', compact('data', 'karyawan'));
    }
    ...
    public function pelunasanbayar($id)
    {
        ...
        $karyawan = Karyawan::get();
        return view('superadmin.pelunasan.create', compact('data', 'pelanggan', 'karyawan'));
    }

    public function simpanpelunasanbayar(Request $req, $id)
    {
        if ($req->karyawan_id == null) {
            toastr()->error('Isi Karyawan Yang Menangani');
            return back();
        }
