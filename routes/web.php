...
Route::group(['middleware' => ['auth', 'role:superadmin']], function () {
    ...
    Route::get('/karyawan', 'SuperadminController@karyawan');
    Route::get('/karyawan/create', 'SuperadminController@karyawancreate');
    Route::post('/karyawan/create', 'SuperadminController@karyawanstore');
    Route::get('/karyawan/edit/{id}', 'SuperadminController@karyawanedit');
    Route::post('/karyawan/edit/{id}', 'SuperadminController@karyawanupdate');
    Route::get('/karyawan/delete/{id}', 'SuperadminController@karyawandelete');
    ...
    Route::get('/laporan/karyawan/cetak', 'LaporanController@karyawancetak');
    Route::get('/laporan/jadwal/cetak', 'LaporanController@jadwalcetak');
});
